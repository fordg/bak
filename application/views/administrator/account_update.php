...
<div id="content">
	...
	<div id="right">
		...
		<div class="box">
			...
			<div class="table">
                <?php echo form_open(base_url().'admin/home/update_proccess/'.$admin->id); ?>
						...
						<tbody>
							<tr>
								<td width="219" class="title">Nama Lengkap</td>
							  	<td width="219" class="price" style="text-align:left;">
							  		<?php echo form_input(array('name'=>'namaLengkap','value'=>$admin->namaLengkap)); ?>                                  
							  	</td>
						  	</tr>
							<tr>
								<td class="title">Username</td>
								<td class="price" style="text-align:left;">
									<?php echo form_input(array('name'=>'username','value'=>$admin->username)); ?>                                    
								</td>
							</tr>
							<tr>
								<td class="title">Email</td>
								<td class="price" style="text-align:left;">
									<?php echo form_input(array('name'=>'email','value'=>$admin->email)); ?>                                    
								</td>
							</tr>
							<tr>
								<td class="title">Telephone</td>
								<td class="price" style="text-align:left;">
									<?php echo form_input(array('name'=>'tlp','value'=>$admin->tlp)); ?>                                    
								</td>
							</tr>
							<tr>
							  	...
							  	<td class="price" style="text-align:left;">
									<span class="price" style="text-align:left;">
								  		<span class="price" style="text-align:left;">
											<?php echo form_input(array('name'=>'alamat','value'=>$admin->alamat,'size'=>'50')); ?>
										</span>
									</span>
								</td>
						  	</tr>
							...
							<tr>
								<td colspan="2" class="title" style="text-align:center">
                                	<?php echo form_submit('update', 'Submit'); ?>                                    
                            	</td>
							</tr>
						</tbody>
				</table>
