			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo $this->session->flashdata('message');?>
                                        <div class="table">
                    <?php echo form_open(base_url().'admin/subkategori/update_proccess/'.$record->idsubkategori); ?>
							...
							<tbody>
								<tr>
								  ...
								  <td width="219" class="price" style="text-align:left;">
								  	<?php 
                                       echo form_input(array('name'=>'namasubkategori','size'=>'40','value'=>$record->namasubkategori)); ?>                                  </td>
                                                                </tr>
                                                                <tr>
                                                                <td></td>
                                                                <td>
                                                                 <select name="id_kategori" id="drop_1">
                                                                <option value="<?php echo $record->id_kategori ?>"><?php echo $record->namaKategori ?></option>
