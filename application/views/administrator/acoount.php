				...
				<div class="box">
					...
					<div class="table">
                    	<table style="width:300px">
							<thead>
								<tr>
									<th colspan="2" class="left">Administrator Information</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td width="119" class="title">Nama Lengkap</td>
								  <td width="169" class="price" style="text-align:left;"><?php echo $admin->namaLengkap; ?></td>
							  </tr>
								<tr>
									<td class="title">Username</td>
									<td class="price" style="text-align:left;"><?php echo $admin->username; ?></td>
								</tr>
								<tr>
									<td class="title">Email</td>
									<td class="price" style="text-align:left;"><?php echo $admin->email; ?></td>
								</tr>
								<tr>
									<td class="title">Telephone</td>
									<td class="price" style="text-align:left;"><?php echo $admin->tlp; ?></td>
								</tr>
								<tr>
									<td class="title">Alamat</td>
									<td class="price" style="text-align:left;"><?php echo $admin->alamat; ?></td>
								</tr>
							</tbody>
						</table>
                        <br />
                        <input type="button" onclick="location.href='<?php echo base_url()."admin/home/update"; ?>'" value="Update Data" />
				  </div>
			  </div>
				<!-- end table -->
			  <!-- messages -->
