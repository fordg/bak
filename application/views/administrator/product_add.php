		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <div class="table">
                    <?php echo form_open_multipart('admin/produk/do_upload'); ?>
                    <table style="width:500px">
						...
						<tbody>
							<tr>
								<td width="219" class="title">Kode Produk</td>
							  	<td width="219" class="price" style="text-align:left;">
							  		<?php echo form_input(array('name'=>'kodeproduk','size'=>'40')); ?>                                  
								</td>
							</tr>
							<tr>
								<td>Stok</td>
                                <td>
                              		<?php foreach ($size as $size_) 
                              		{
							...
							<tr>
								<td width="219" class="title">Nama Produk</td>
							  	<td width="219" class="price" style="text-align:left;">
							  		<?php echo form_input(array('name'=>'namaproduk','size'=>'40')); ?>                                  
								</td>
							</tr>
							<tr>
								<td width="219" class="title">Harga</td>
								<td width="219" class="price" style="text-align:left;">
									<?php echo form_input(array('name'=>'harga','size'=>'40')); ?>                                  
								</td>
							</tr>
							<tr>
								<td width="219" class="title">Berat</td>
								<td width="219" class="price" style="text-align:left;">
									<?php echo form_input(array('name'=>'berat','size'=>'20')); ?>  .KG                                
								</td>
							</tr>
							<tr>
						...
						<tr>
							<td colspan="2" class="title" style="text-align:center"></td>
						</tr>
					</tbody>
				</table>
				<?php echo form_close(); ?>
