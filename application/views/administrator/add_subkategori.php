			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo $this->session->flashdata('message');?>
                                        <div class="table">
                    <?php echo form_open(base_url().'admin/subkategori/add_proccess/'); ?>
                    <table style="width:450px">
							...
							<tbody>
								<tr>
									...
									<td width="219" class="title">Nama Sub Kategori</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'namasubkategori','size'=>'40','id'=>'subk')); ?>                                  </td>
							  </tr>
                                   ...
                                   <td>Kategori</td>
                                   	<td width="219" class="price" style="text-align:left;">
								  		<div class="select"> 
                                                                                        <select name="id_kategori" id="kate">
                                                                                            <option disabled="disabled" value="0" selected="selected">-Pilih Kategori-</option>
