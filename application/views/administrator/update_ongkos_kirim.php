			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title --> 
                                         <div class="table">
                                         <?php ?>
                    <?php echo form_open(base_url().'admin/jasa/ubah_data/'.$record[0]->id_ongkos_kirim); ?>
                    ...
                    <table style="width:450px">
                            ...
                            <select id="idprovinsi"> 
                             ...
                             if($provinsi_dari_kota[0]->idprovinsi==$value['idprovinsi'])
                             echo "<option selected='' value='".$value['idprovinsi']."'>". $value['namaprovinsi']. "</option>";
                             else
                            ...
                            <select id="id_jasa_pengiriman"> 
                             <?php foreach ($jasapengiriman as $value) {
                             if($jasapengiriman_dari_paketjasa[0]->id_jasa_pengiriman==$value['id_jasa_pengiriman'])
                             echo "<option selected='' value='".$value['id_jasa_pengiriman']."'>". $value['nama_jasa_pengiriman']. "</option>";
                             else
                             echo "<option value='".$value['id_jasa_pengiriman']."'>". $value['nama_jasa_pengiriman']. "</option>";
                             } ?>
                            </select> 
                            </td>
                            </tr>
                            ...
                            <td>
								...
								<tr>
								  ...
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('id'=>'biaya','name'=>'biaya_ongkos_kirim','size'=>'40','value'=>$record[0]->biaya_ongkos_kirim)); ?>   
                                      	 <input type="hidden" name="tabel" value="jasa_pengiriman" />
                                                     </td>
                                                                </tr>
                                                                <tr>
									<td width="219" class="title">Lama Pengiriman</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('id'=>'lama','name'=>'lama_pengiriman','size'=>'20','value'=>$record[0]->lama_pengiriman)); ?>   
                                      	 <input type="hidden" name="tabel" value="ongkos_kirim" /> hari
                                                     </td>
                                                                </tr>
								<tr>
