			...
			<div id="right">
				...
				<div class="box">
					...
					<div class="title">
						<h5>Ukuran</h5>
						<div class="search">
							<form action="<?php echo base_url(); ?>admin/jasa/cari/provinsi" method="post">
								<div class="input">
...
<thead>
								<tr>
								  ...
								  <th width="220"> Nama Jasa Pengiriman</th> 
							...
							<tbody>
								<tr>
                            									...
                            									<td ><?php echo $row['nama_jasa_pengiriman']; ?></td>
                                                                        <td width="45" class="date"><a href="<?php echo base_url().'admin/jasa/update_jasa_pengiriman/'.$row['id_jasa_pengiriman']; ?>">Update</a></td>
                                                                        <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/jasa/hapus/jasa_pengiriman/'.$row['id_jasa_pengiriman']; ?>')">Delete</a></td>
							      </tr>
                                                                <?php 
                                                                $i++; 
                                                                endforeach; 
