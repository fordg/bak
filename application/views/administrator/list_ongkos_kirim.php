				...
				<div class="box">
					...
					<div class="table">
						<table style="width:950px">
                            <thead>
								<tr>
								  <th width="126" class="left">No</th>
								  <th width="120"> Nama Jasa Pengiriman</th> 
								  <th width="120"> Nama Paket Jasa</th>  
								  <th width="120"> Nama provinsi</th> 
								  <th width="120"> Nama Kota</th>  
								  <th width="120"> Biaya</th> 
								  <th width="120"> Lama Pengiriman</th> 
							...
							<tbody>
								<tr>
                                                                ...
                                                                foreach($result as $row) :  
                                                                 ...
                                                                 ?>
                            									<td ><?php echo $i; ?></td>
                            									<td ><?php echo $row['nama_paket_jasa']; ?></td>
                                                               	<td ><?php echo $row['nama_jasa_pengiriman']; ?></td>
                                                                <td ><?php echo $row['namaprovinsi']; ?></td>
                                                               	<td ><?php echo $row['namakota']; ?></td>
                                                                <td ><?php echo $row['biaya_ongkos_kirim']; ?></td>
                                                               	<td ><?php echo $row['lama_pengiriman']; ?></td>
                                                                        <td width="25" class="date"><a href="<?php echo base_url().'admin/jasa/update_ongkos_kirim/'.$row['id_ongkos_kirim']; ?>">Update</a></td>
                                                                        <td width="20" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/jasa/hapus/ongkos_kirim/'.$row['id_ongkos_kirim']; ?>')">Delete</a></td>
							      </tr>
                                                                <?php 
                                                                $i++; 
                                                                endforeach; 
