			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo $this->session->flashdata('message');?>
                                        <div class="table">
                    <?php echo form_open(base_url().'admin/bank/tambah_'); ?> 
                    <table style="width:450px">
                            ...
                            <td>Nama Bank</td>
                            <td>
                            <?php echo form_input(array('name'=>'namabank','size'=>'40')); ?>                             
                            </td>
                            </tr>
								<tr>
									<td width="219" class="title">Atas Nama</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'atasnama','size'=>'40')); ?>                                  </td>
					 
                         	  </tr>
                              <tr>
									<td width="219" class="title">Nomor rekening</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'norekening','size'=>'40')); ?>                                  </td>
