...
<thead>
								<tr>
								  ...
								  <th width="20"> Nama Jasa Pengiriman</th> 
								  <th width="20"> Nama Paket Jasa</th> 
								...
								<tr>
                            									...
                            									<td ><?php echo $row['nama_paket_jasa']; ?></td>
                                                               	<td ><?php echo $row['nama_jasa_pengiriman']; ?></td>
                                                                        <td width="45" class="date"><a href="<?php echo base_url().'admin/jasa/update_paket_jasa/'.$row['id_paket_jasa']; ?>">Update</a></td>
                                                                        <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/jasa/hapus/paket_jasa/'.$row['id_paket_jasa']; ?>')">Delete</a></td>
							      </tr>
                                                                <?php 
                                                                $i++; 
                                                                endforeach; 
