			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo $this->session->flashdata('message');?>
                                        <div class="table">
                    <?php echo form_open(base_url().'admin/ongkir/tambah_'); ?>
							...
							<tbody>
								<tr>
								  ...
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'kota','size'=>'40')); ?>                                  </td> 
                         	  </tr>
                              	<tr>
									<td width="219" class="title">Servis</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'service','size'=>'40')); ?>                                  </td> 
                         	  </tr>
                              	<tr>
									<td width="219" class="title">Lama pengiriman</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'waktu','size'=>'40')); ?>                                  </td> 
                         	  </tr>
                              	<tr>
									<td width="219" class="title">Biaya pengiriman</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'biaya','size'=>'40')); ?>                                  </td> 
                         	  </tr>
								<tr>
