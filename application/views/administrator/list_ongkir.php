								...
								<tr>
                            									...
                            									<td ><?php echo $row->service; ?></td>
                                                               	...
                                                               	<td ><?php echo "Rp ". number_format ($row->biaya,0,",",",") ?></td>
                                                                         <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/ongkir/hapus/'.$row->id_ongkos_kirim; ?>')">Delete</a></td>
							                <td width="39" class="category"><a href="<?php echo base_url().'admin/ongkir/update/'.$row->id_ongkos_kirim; ?>">Update</a></td>
							      </tr>
                                                                <?php 
                                                                $i++; 
                                                                endforeach; 
