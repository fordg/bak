							...
							<tbody>
								<tr>
									...
									<td ><?php echo $row->namaKategori; ?></td>
								 	<td width="45" class="date"><a href="<?php echo base_url().'admin/category/update/'.$row->id_kategori; ?>">Update</a></td>
                                    <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/category/delete/'.$row->id_kategori; ?>')">Delete</a></td>
							  </tr>
                                    <?php 
	                                    $i++; 
	                                    endforeach; 
