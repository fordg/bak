								...
								<tr>
                            									...
                            									<td ><?php echo $row['namakota']; ?></td>
                                                               	<td ><?php echo $row['namaprovinsi']; ?></td>
                                                                        <td width="45" class="date"><a href="<?php echo base_url().'admin/wilayah/update_kota/'.$row['idkota']; ?>">Update</a></td>
                                                                        <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/wilayah/hapus/kota/'.$row['idkota']; ?>')">Delete</a></td>
							      </tr>
                                                                <?php 
                                                                $i++; 
                                                                endforeach; 
