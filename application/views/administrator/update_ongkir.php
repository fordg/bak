			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo $this->session->flashdata('message');?>
                                        <div class="table"> 
                    <?php echo form_open(base_url().'admin/ongkir/update_'); ?>
                    <table style="width:450px">
							...
							<tbody>
								<tr>
									<td width="219" class="title">Kota, Kecamatan</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'kota','size'=>'40','value'=>$record->kota)); ?>                                  </td> 
                         	  </tr>
                              	<tr>
									<td width="219" class="title">Servis</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'service','size'=>'40','value'=>$record->service)); ?>                                  </td> 
                         	  </tr>
                              	<tr>
									<td width="219" class="title">Lama pengiriman</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'waktu','size'=>'40','value'=>$record->waktu)); ?>                                  </td> 
                         	  </tr>
                              	<tr>
									<td width="219" class="title">Biaya pengiriman</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'biaya','size'=>'40','value'=>$record->biaya)); ?>                                  </td> 
                         	  </tr>
								<tr>
									<td colspan="2" class="title" style="text-align:center">
                                    <input type="hidden" name="id_ongkos_kirim" value="<?php echo $record->id_ongkos_kirim ?>" />
