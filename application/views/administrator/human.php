	...
	<div id="right">
		...
		<div class="box">
			...
			<div class="title">
				<h5>Kategori</h5>
				<div class="search">
					<form action="<?php echo base_url(); ?>admin/human/cari" method="post">
						<div class="input">
				...
				<table style="width:350px">
					...
					<tbody>
						<tr>
							...
							?>
							<td ><?php echo $i; ?></td>
							<td ><?php echo $row->namaHuman; ?></td>
                            <td width="45" class="date"><a href="<?php echo base_url().'admin/human/update/'.$row->id_human; ?>">Update</a></td>
                            <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/human/delete/'.$row->id_human; ?>')">Delete</a></td>
					  	</tr>
                        <?php 
                       		$i++; 
                            endforeach; 
