			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo $this->session->flashdata('message');?>
                                        <div class="table">
                    <?php echo form_open(base_url().'admin/category/update_proccess/'.$record->id_kategori); ?>
							...
							<tbody>
								<tr>
								  ...
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'namakategori','size'=>'40','value'=>$record->namaKategori)); ?>                                  </td>
                                                                </tr>
								<tr>
									<td colspan="2" class="title" style="text-align:center">
                                    <?php echo form_submit('update', 'Submit'); ?>                                    </td>
								</tr>
							</tbody>
						</table>
                      <?php echo form_close(); ?>
