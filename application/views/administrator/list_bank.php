				...
				<table style="width:550px">
					...
					<tbody>
						<tr>
                            ...
                            <td width="45" class="date"><a href="<?php echo base_url().'admin/bank/update_kota/'.$row['idbank']; ?>">Update</a></td>
							<td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/bank/hapus/'.$row['idbank']; ?>')">Delete</a></td>
						</tr>
						<?php 
							$i++; 
							endforeach;  
