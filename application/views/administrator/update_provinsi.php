		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title --> 
                                         <div class="table">
                    <?php echo form_open(base_url().'admin/wilayah/ubah_data/'.$record[0]->idprovinsi); ?>
							...
							<tbody>
								<tr>
								  ...
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'namaprovinsi','size'=>'40','value'=>$record[0]->namaprovinsi)); ?>   
                                      	 <input type="hidden" name="tabel" value="provinsi" />
                                                     </td>
                                                                </tr>
								<tr>
