			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title --> 
                                         <div class="table">
                                         <?php ?>
                    <?php echo form_open(base_url().'admin/jasa/ubah_data/'.$record[0]->id_jasa_pengiriman); ?>
                    <table style="width:450px">
							...
							<tbody>
								<tr>
									<td width="219" class="title">Nama Jasa Pengiriman</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('id'=>'nama_paket_jasa','name'=>'nama_jasa_pengiriman','size'=>'40','value'=>$record[0]->nama_jasa_pengiriman)); ?>   
