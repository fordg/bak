...
<thead>
								<tr>
								  ...
								  <th width="220">Nama SubKategori</th>
							...
							<tbody>
								<tr>
								    ...
								    <td width="45" class="date"><a href="<?php echo base_url().'admin/subkategori/update/'.$row->idsubkategori; ?>">Update</a></td>
                                    <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/subkategori/delete/'.$row->idsubkategori; ?>')">Delete</a></td>
