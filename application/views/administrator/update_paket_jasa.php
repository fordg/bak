		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title --> 
                                         <div class="table">
                    <?php echo form_open(base_url().'admin/jasa/ubah_data/'.$record[0]->id_paket_jasa); ?>
                    <table style="width:450px">
                            ...
                            <td>
                            <select name="id_jasa_pengiriman" id="drop_1">
                             <option disabled="disabled" selected="selected">-Pilih Jasa Pengiriman-</option>
                             <?php foreach ($prov as $value) {
                            if($record[0]->id_jasa_pengiriman==$value['id_jasa_pengiriman'])
                             ...
                             echo "<option value='".$value['id_jasa_pengiriman']."'>". $value['nama_jasa_pengiriman']. "</option>";
								...
								<tr>
								  ...
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('id'=>'nama_paket_jasa','name'=>'nama_paket_jasa','size'=>'40','value'=>$record[0]->nama_paket_jasa)); ?>   
                                      	 <input type="hidden" name="tabel" value="paket_jasa" />
                                                     </td>
                                                                </tr>
								<tr>
									<td colspan="2" class="title" style="text-align:center">
                                    <?php echo form_submit('', 'Submit'); ?>                                    </td>
								</tr>
							</tbody>
						</table>
                      <?php echo form_close(); ?>
