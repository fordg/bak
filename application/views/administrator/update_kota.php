		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
                    ...
                    <?php echo form_open(base_url().'admin/wilayah/ubah_data/'.$record[0]->idkota); ?>
                    <table style="width:450px">
                            ...
                            <td>Nama Provinsi</td>
                            <td>
                            <select name="idprovinsi" id="drop_1">
                             <option disabled="disabled" selected="selected">-Pilih Provinsi-</option>
                             <?php foreach ($prov as $value) {
                            if($record[0]->idprovinsi==$value['idprovinsi'])
                             ...
                             echo "<option value='".$value['idprovinsi']."'>". $value['namaprovinsi']. "</option>";
								...
								<tr>
									<td width="219" class="title">Nama Kota</td>
								  <td width="219" class="price" style="text-align:left;">
								  	<?php echo form_input(array('name'=>'namakota','size'=>'40','value'=>$record[0]->namakota)); ?>   
                                      	 <input type="hidden" name="tabel" value="kota" />
                                                     </td>
                                                                </tr>
								<tr>
