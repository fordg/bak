							...
							<tbody>
								<tr>
									...
									<td ><?php echo $row['ukuran_produk']; ?></td>
                                                                        <td width="45" class="date"><a href="<?php echo base_url().'admin/size/update/'.$row['id']; ?>">Update</a></td>
                                                                        <td width="39" class="category"><a href="javascript:confirmDelete('<?php echo base_url().'admin/size/delete/'.$row['id']; ?>')">Delete</a></td>
							  </tr>
                                                                <?php 
                                                                $i++; 
                                                                endforeach; 
